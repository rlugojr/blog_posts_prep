...
Last week I introduced [my Shiny app](https://shiring.shinyapps.io/wgs_app/), where you can explore 160 measurements over 56 years. This week I've put included a statistical analysis of these measurements and put some finishing touches on the app.

Alternatively, you can load the app via Github with the **shiny** package. [There, you can also find the source code for the app](https://github.com/ShirinG/WGS_app).
...
```{r echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=16, fig.height=8, fig.align="center", cache=TRUE}
load("measures.RData")
load("years.RData")
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=16, fig.height=8, fig.align="center", cache=TRUE}
library(ggplot2)
...
```{r echo=FALSE, eval=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=4, fig.align="center", cache=TRUE}
library(dplyr)
...
```{r echo=FALSE, eval=FALSE, message=FALSE, warning=FALSE, fig.width=16, fig.height=8, fig.align="center", cache=TRUE}
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=4, fig.align="center", cache=TRUE}
library(dplyr)
...
```{r echo=FALSE, eval=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=4, fig.align="center", cache=TRUE}
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=15, fig.height=12, fig.align="center", cache=TRUE}
left_join(subset(year_table_last_val, Indicator.Name %in% sig$Indicator.Name), country.inf, by = c("Country.Code" = "adm0_a3")) %>%
  ...
  labs(
    ...
    y = "log2(male/ female)")
```
```{r echo=FALSE, eval=FALSE, message=FALSE, warning=FALSE, fig.width=15, fig.height=12, fig.align="center", cache=TRUE}
sig %>%
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=15, fig.height=20, fig.align="center", cache=TRUE}
