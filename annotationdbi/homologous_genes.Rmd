...
labels$description[grep("hedgehog", labels$description, ignore.case = TRUE)][2] <- "Hedgehog Tenrec"
...
labels[grep("Hedgehog", labels$description), ]
```
...
```{r echo = TRUE, message = FALSE, warning = FALSE, cache=FALSE, fig.width = 10, fig.height = 20, fig.align = "center"}
