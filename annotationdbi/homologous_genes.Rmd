...
labels$description[grep("hedgehog", labels$description)] <- "Hedgehog"
...
plot(g,
     vertex.label.font = 1,
     vertex.shape = "sphere",
     vertex.size=number_genes/900,
     vertex.label.cex=1,
     vertex.label.color="white",
     vertex.frame.color = NA,
     edge.width = E(g)$weight/5000)
...
net_d3$nodes <- merge(net_d3$nodes, as.data.frame(number_genes), by.x = "name", by.y = "row.names")
net_d3$nodes$number_genes <- net_d3$nodes$number_genes/900
