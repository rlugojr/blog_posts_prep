...
E(g)$arrow.size <- edge_table$weight*3
E(g)$edge.color <- "gray80"
E(g)$width <- edge_table$weight*3
...
Node size shows the total number of genes of each species and edge width shows the proportion of these genes with homologs in the respective other species.
