...
The Google location history can be downloaded from your Google account under [http://takeout.google.com/](http://takeout.google.com/). Make sure you only tick *"location history"* for download, otherwise it will probably take super long to get all your Google data.
...
Before I get to actual plotting of map data, I want to explore a few basic statistics of the data.
