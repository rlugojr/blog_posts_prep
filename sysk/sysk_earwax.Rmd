...
for (name in names){
  sentiment <- data.frame(document_ID = 1:length(get(paste("lines", name, sep = "_"))), 
...
head(sentiment_Josh)
head(sentiment_Chuck)
```

```{r echo = TRUE, message = FALSE, warning = FALSE, cache=FALSE, fig.width = 10, fig.height = 5, fig.align = "center"}
for (name in names){
  sentiment_percent_vals <- data.frame(
...
head(sentiment_percent_vals_Josh)
head(sentiment_percent_vals_Chuck)
```

```{r echo = TRUE, message = FALSE, warning = FALSE, cache=FALSE, fig.width = 10, fig.height = 5, fig.align = "center"}
for (name in names){
  assign(paste("get_nrc_sentiment", name, sep = "_"), get_nrc_sentiment(get(paste("lines", name, sep = "_"))))
}

head(get_nrc_sentiment_Josh)
head(get_nrc_sentiment_Chuck)
```
