...
```{r eval=FALSE, echo=FALSE, fig.width=5, fig.height=3}
...
```{r warning=FALSE, message=FALSE, fig.width=20, fig.height=20, fig.align='center'}
library(reshape2)
...
```{r echo=FALSE}
dl_model <- h2o.loadModel(dl_model)
```
