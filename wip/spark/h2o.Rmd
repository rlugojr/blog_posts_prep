...
http://spark.rstudio.com/h2o.html#overview
...
for(response in countries) {
  ...
  features <- features[grep("_trans", features)]
  
  gbm_model <- h2o.gbm(x = features, 
                       y = response,
  ...
  h2o.performance(gbm_model, newdata = test)
}
```
...
for(response in countries) {
  ...
  dl_fit <- h2o.deeplearning(x = features, 
                             y = response,
                             training_frame = training,
                             epochs = 15,
  ...
  h2o.performance(dl_fit, newdata = test)
}
```
